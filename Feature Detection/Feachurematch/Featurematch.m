...
% Match Features
I1L1R = matchFeatures(I1_lFeatures, I1_rFeatures, 'MatchThreshold', 0.15); 
I1R2R = matchFeatures(I1_rFeatures, I2_rFeatures, 'MatchThreshold', 0.15);
I2R2L = matchFeatures(I2_rFeatures, I2_lFeatures, 'MatchThreshold', 0.15); 
I2L1L = matchFeatures(I2_lFeatures, I1_lFeatures, 'MatchThreshold', 0.15); 
